...
static constexpr auto qt_meta_stringdata_CLASSSolverENDCLASS = QtMocHelpers::stringData(
    "Solver"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSSolverENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSSolverENDCLASS_t qt_meta_stringdata_CLASSSolverENDCLASS = {
    {
